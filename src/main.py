...
bot = telebot.TeleBot('1938658134:AAGdEjhogVEbxrgIZYlmXeLA5etlCUXiaQY')
...
def get_text_messages(message):
    if message.text == 'Привет':
        bot.send_message((message.from_user.id, "Здарова, бандит! Сейчас выдам тебе твой гороскоп"))
    elif message.text == '/help':
        bot.send_message(message.from_user.id, "Напиши мне, Привет, дядя")
    else:
        bot.send_message(message.from_user.id, "Да, Привет, напиши блин")
...
zodiac = int(input("{blue}Введите число с номером знака зодиака:"
